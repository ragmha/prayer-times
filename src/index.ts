...
const getPrayerTimes = async (
  ...
  return [
    {
      name: "Fajr",
      time: DateTime.fromISO(timings.Fajr, {
        zone: "Europe/Helsinki",
      }).toLocaleString(DateTime.TIME_SIMPLE),
    },
    {
      name: "Dhuhr",
      time: DateTime.fromISO(timings.Dhuhr, {
        zone: "Europe/Helsinki",
      }).toLocaleString(DateTime.TIME_SIMPLE),
    },
    {
      name: "Asr",
      time: DateTime.fromISO(timings.Asr, {
        zone: "Europe/Helsinki",
      }).toLocaleString(DateTime.TIME_SIMPLE),
    },
    {
      name: "Maghrib",
      time: DateTime.fromISO(timings.Maghrib, {
        zone: "Europe/Helsinki",
      }).toLocaleString(DateTime.TIME_SIMPLE),
    },
    {
      name: "Isha",
      time: DateTime.fromISO(timings.Isha, {
        zone: "Europe/Helsinki",
      }).toLocaleString(DateTime.TIME_SIMPLE),
    },
  ]
